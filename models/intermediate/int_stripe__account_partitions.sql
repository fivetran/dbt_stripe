        ...
        *,
        ...
        sum(case when {{ f }} is null  
            then 0  
                ...
                end) over (partition by account_id{{ fivetran_utils.partition_by_source_relation(package_name='stripe') }} order by date_day rows unbounded preceding) as {{ f }}_partition
