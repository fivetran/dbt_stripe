...
| **Table** | **Example Analytics Questions** | **Description** |
|-----------|-----------------|-------------------------------|
| [stripe__balance_transactions](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__balance_transactions) | • What types of transactions are most impacting my Stripe balance?<br><br>• How much did fees, refunds, or disputes reduce net revenue this quarter? | Represents each change to your Stripe balance with transaction context. |
| [stripe__invoice_details](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__invoice_details)  | • What is the average invoice value by customer segment?<br><br>• Which customers have the highest outstanding invoices? | Contains invoice records with associated charge, customer, and subscription data. |
| [stripe__invoice_line_item_details](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__invoice_line_item_details)  | • Which products or services contribute most to total invoiced revenue?<br><br>• Are there any products consistently discounted or refunded? | Includes line items with charge, customer, subscription, and pricing details. |
| [stripe__daily_overview](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__daily_overview) | • What is the trend in daily net payments and refunds?<br><br>• What is the MRR trend over the last 6 months? | Summarizes daily and rolling Stripe transaction totals by type. |
| [stripe__subscription_details](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__subscription_details) | • How many active subscriptions are there by plan or product?<br><br>• What is the average customer subscription length before cancellation? | Contains subscription records with customer and payment metrics. |
| [stripe__customer_overview](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__customer_overview) | • Who are the top 10 customers by total lifetime value?<br><br>• How many customers made a payment in the last 90 days? | Shows customer-level metrics with transaction details and associations. |
| [stripe__activity_itemized_2](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__activity_itemized_2) | • What are the exact transaction-level fees for each invoice or customer?<br><br>• How much are we paying in interchange and platform fees per transaction? | Lists balance transactions with invoice, fee, refund, and customer data. |
| [stripe__balance_change_from_activity_itemized_3](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__balance_change_from_activity_itemized_3) | • What was the source of each Stripe balance change over the last month?<br><br>• How accurate is my accounting ledger compared to Stripe's balance records? | Reconciles Stripe balance changes like a detailed bank statement. |
| [stripe__ending_balance_reconciliation_itemized_4](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__ending_balance_reconciliation_itemized_4) | • Which transactions remain unsettled as of the last payout?<br><br>• Do all automatic payouts reconcile fully with balance changes? | Matches bank payouts with unsettled Stripe transactions. |
| [stripe__payout_itemized_3](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__payout_itemized_3) | • When should I expect my next payout, and for how much?<br><br>• Are there any delayed or failed payouts that need follow-up? | Details expected and actual payout amounts and statuses. |
| [stripe__line_item_enhanced](https://fivetran.github.io/dbt_stripe/#!/model/model.stripe.stripe__line_item_enhanced) | • What are the top revenue-generating products or SKUs?<br><br>• What is the average revenue per user (ARPU) by subscription plan? | Provides unified reporting across billing platforms on product, customer, and revenue metrics. See the [Fivetran Billing Model Streamlit App](https://fivetran-billing-model.streamlit.app/) for more details. |
