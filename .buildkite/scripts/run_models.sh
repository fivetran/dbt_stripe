...
dbt test --target "$db"
dbt run --vars '{stripe__using_payouts: false, stripe__using_transfers: false, stripe__using_invoices: false, stripe__using_payment_method: false, stripe__using_subscriptions: false, stripe__using_coupons: false, stripe__using_subscription_discounts: false, stripe_timezone: "America/New_York", stripe__using_subscription_history: false, stripe__using_price: false, stripe__convert_values: true, stripe__using_credit_notes: true, stripe__standardized_billing_model_enabled: false}' --target "$db"
dbt test --target "$db"
